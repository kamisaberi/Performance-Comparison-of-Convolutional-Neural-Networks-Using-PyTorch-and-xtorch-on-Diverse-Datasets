...
int main()
{
     ...
     */
    auto dataset = xt::data::datasets::Imagenette(
        "/home/kami/Documents/datasets/", DataMode::TRAIN, true, xt::data::datasets::ImageType::PX160,
        {
    ...
    xt::models::ResNet18 model({3, 4, 6, 3}, 10, 3);
